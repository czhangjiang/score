...
<head>
  ...
  <meta name="description" content="您说我办管理中心" />
  <meta name="author" content="Joy" />
  <title>会佳心语管理中心</title>
...
<body class="page-body">
  <div class="page-container @if(isset($_COOKIE['sidebar_status']) && $_COOKIE['sidebar_status'] == 'hide') sidebar-collapsed @endif">
    ...
    <div class="main-content container">
      ...
      <!-- Footer -->
      <footer class="main">
        &copy; {{date('Y')}} <strong>会佳心语中心</strong>
        Powered by 
  ...
  @yield('page_js')
  <script src="{{ asset('/js/admin-common.js') }}" id="script-resource-23"></script>
</body>
</html>